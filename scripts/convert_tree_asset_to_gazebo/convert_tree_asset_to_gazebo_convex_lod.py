...
def parse_args(argv):
    parser = argparse.ArgumentParser(
        description="Convert a Blender tree asset into a Gazebo model directory with optional convex-hull leaf LOD."
    )
    ...
    parser.add_argument(
        "--leaf-lod-mode",
        choices=("original", "joined", "convex_hull", "none"),
        default="original",
        help="How to export leaf visuals. convex_hull replaces leaf meshes with clustered low-poly hulls.",
    )
